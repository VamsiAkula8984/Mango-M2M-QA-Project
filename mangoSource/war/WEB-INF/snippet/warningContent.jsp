    ...
    <c:if test="${pointRT.attributes.UNRELIABLE}">
      <tr>
        ...
        <td style="white-space:nowrap;" colspan="3">
          ...
          <tag:img png="arrow_refresh" title="common.refresh" onclick="LandingPageDwr.forcePointRead(${point.id})" style="display:inline"/> <%-- new line added for the landing page --%>
        </td>
      </tr>
    </c:if>
